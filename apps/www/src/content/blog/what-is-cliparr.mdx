...
Cliparr is a self-hosted video clipper for Plex, Jellyfin, and local files.
It uses a small server for provider access, saved sources, and secure persistence, while the editing and export workflow runs in the browser.
