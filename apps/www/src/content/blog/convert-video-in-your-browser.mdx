...
Because Cliparr already transcodes in the browser, it made sense to pull that part out into a small public tool: [Cliparr Convert](/convert/), a simple offline video converter available in your browser.
...
If you're looking for a simple, ad-free, in-browser, no-account-needed media converter, give it a try.
...
Consider "installing" the convert tool as a Progressive Web App, to make sure you always have it handy and loading quickly.
