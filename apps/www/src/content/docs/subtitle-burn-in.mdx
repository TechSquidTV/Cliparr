...
import subtitlePanelImage from "../../../public/docs/subtitle-panel.webp";
...
<figure class="my-6 overflow-hidden rounded-lg border border-border bg-card">
  <Picture
    src={subtitlePanelImage}
    alt="Cliparr subtitle panel showing track selection and burn-in style controls."
    formats={["avif", "webp"]}
    fallbackFormat="webp"
